---
name: android-orchestrator-systematic-debugging
description: Diagnose the root cause of an Android Orchestrator task failure before the single permitted repair loop
license: MIT
...
1. **Create Failing Test Case**
   ...
   - Use `android-orchestrator-test-driven-development` for proper failing tests
...
3. **Verify Fix**
   ...
   - Use `android-orchestrator-verification-before-completion` before claiming success
